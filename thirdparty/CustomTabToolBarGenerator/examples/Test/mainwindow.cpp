    ...
    ui(new Ui::MainWindow)
{
    ...
    ((QComboBox*)ttb["customComboBox"])->addItems(QStringList() << "Item 1" << "Item 2" << "Item 3");
    ((QComboBox*)ttb["customComboBox2"])->addItems(QStringList() << "Item 4" << "Item 5" << "Item 6");
    QPushButton* btn = (QPushButton*)ttb["customEditButton"];
    QComboBox* comboboxEdit = (QComboBox*)ttb["customComboBox"];
    comboboxEdit->clear();
    btn->setText("Edit");
    editPage = (tt::Page*)ttb["Edit"];
    viewPage = (tt::Page*)ttb["View"];
    viewPage2 = (tt::Page*)ttb["View2"];
    helpPage = (tt::Page*)ttb["Help"];
    viewPage2->hide();
...
void CMainWindow::on_pushButton_clicked()
{
    ...
    CMainWindow::kek = !CMainWindow::kek;
}
