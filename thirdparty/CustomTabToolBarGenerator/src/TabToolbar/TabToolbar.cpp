    ...
    groupMaxHeight(_groupMaxHeight)
{
    ...
    tabBar = new CustomTabWidget(this);
    ...
    logoLabel->setPixmap(QPixmap(":/icons/icons/XMotionLogo.svg"));
    logoLabel->setContentsMargins(5, 0, 50, 10);
    logoLabel->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
    logoLabel->setAlignment(Qt::AlignCenter);
    tabBar->setCornerWidget(logoLabel, Qt::TopLeftCorner);
    ...
    cornerLayout->addWidget(hideButton);         // Hide butonu ekler.
    tabBar->setCornerWidget(cornerActions);      // Hide butonu sol alt köşeye alır
